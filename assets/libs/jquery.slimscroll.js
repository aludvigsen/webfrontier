        ...
        slimScroll: function(options) {
            ...
            this.each(function(){
                ...
                var isOverPanel, isOverBar, isDragg, queueHide, touchDif,
                    barHeight, contentHeight, percentScroll, lastScroll,
                    divS = '<div></div>',
                    minBarHeight = 30,
                    releaseScroll = false;
                ...
                function getBarHeight()
                {
                    ...
                    barHeight = Math.max((getOuterHeight() / me[0].scrollHeight) * getOuterHeight(), minBarHeight);
                    bar.css({ height: barHeight + 'px' });

                    // content height
                    contentHeight = me.find(":first-child").outerHeight();

                    // hide scrollbar if content is not long enough
                    var display = barHeight > contentHeight ? 'none' : 'block';
                ...
                function getOuterHeight() {
                    return me.outerHeight() - o.margin;
                }
